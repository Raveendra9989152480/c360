...
constituency_name = 'Shadnagar_84'
for folder in all_folders:
    ...
    if folder == 'Shadnagar_84':
        ...
        result_df.to_excel(f'C:\\Users\\admin\\Desktop\\R\\Beneficiary_original\\Mahbubnagar_74\\{constituency_name}_o_beneficiary_scheme.xlsx',index=False)
        print("success..")
        ...
        result_df.to_excel(f'C:\\Users\\admin\\Desktop\\R\\Beneficiary_unique\\Mahbubnagar_74\\{constituency_name}_u_beneficiary_scheme.xlsx',index=False)
        print("success..")
